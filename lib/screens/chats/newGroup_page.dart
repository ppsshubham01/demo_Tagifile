                  ...
                  Column(children: [
                    ...
                    Row(
                      ...
                      children:  [
                        const Row(
                          children: [
                          CircleAvatar(radius: 20,backgroundImage: NetworkImage("https://source.unsplash.com/random"),),
                          SizedBox(width: 8,),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Shubham Prajapati",style: TextStyle(overflow: TextOverflow.ellipsis,),),
                              Text("@softHeartedGentalmen",style: TextStyle(overflow: TextOverflow.ellipsis,),),
                            ],
                          ),
                        ],),
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: DropdownButton<String>(
                                ...
                                items: <String>['Viewer', 'Admin'].map((String value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Row(
                                      children: [
                                        const Icon(Icons.remove_red_eye_outlined,color: Color(0xFF0AB210),), // Leading icon
                          ...
                          IconButton(onPressed: (){}, icon: const Icon(Icons.do_disturb_on_outlined,color: Colors.red,))
                        ],)
